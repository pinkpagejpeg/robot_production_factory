...
const CoinsModal = ({ visible, setVisible }) => {
    ...
    return (
        <div className={rootClasses.join(' ')}>
            <div className={classes.coins__modal_content}>
                <div className={classes.coins__close_wrapper}>
                    <button className={classes.button_close} onClick={handleCloseModal}><img src={close} alt="Close" /></button>
                </div>
                <div className={classes.coins__info}>
                    <img className={classes.coins__image} src={coins} alt="Coins" />
                    <div className={classes.coins__message}>
